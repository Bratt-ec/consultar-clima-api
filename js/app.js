...
function buscarClima(e){
    ...
    if( ciudad === '' || pais === ''){
        mostrarError('Ambos campor son obligatorios');

        return
    }

    // consultamo en la API
...
function mostrarError(mensaje){
    ...
    if(!alerta){  
        divMensaje.classList.add('bg-red-100','border-red-400', 'text-red-700','px-4','py-3',
...
function mostrarClima(datos){
    ...
    // temp - 213.15   - conversion de Kelvin a Centigrados
